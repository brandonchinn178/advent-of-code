...
main :: IO ()
main = do
  program <- readProgram <$> readFile "Day9.txt"

  print $ part1 program
  print $ part2 program

part1 :: Program -> Integer
part1 = getOutput . runProgram [1]

part2 :: Program -> Integer
part2 = getOutput . runProgram [2]

getOutput :: [Integer] -> Integer
getOutput [output] = output
getOutput outputs = error $ "Program returned multiple outputs: " ++ show outputs
